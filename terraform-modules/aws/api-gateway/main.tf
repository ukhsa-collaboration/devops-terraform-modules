...
module "resource_name_prefix" {
  source = "git@github.com:UKHSA-Internal/devops-terraform-modules.git//terraform-modules/resource-name-prefix?ref=TF/helpers/resource-name-prefix/vALPHA_0.0.0"
