...
| <a name="input_lz_backup_plan"></a> [lz\_backup\_plan](#input\_lz\_backup\_plan) | (Specific Mandatory) The backup plan that should be associated with the resource. | `string` | n/a | yes |
...
| <a name="input_lz_business_owner"></a> [lz\_business\_owner](#input\_lz\_business\_owner) | (Mandatory) Business person responsible for the workload. First point of contact for business related enquiries. Only required if different from TechOwner. | `string` | n/a | yes |
...
| <a name="input_lz_health_data"></a> [lz\_health\_data](#input\_lz\_health\_data) | (Optional) Whether the data held is related to health information. | `string` | `""` | no |
| <a name="input_lz_lean_ix_id"></a> [lz\_lean\_ix\_id](#input\_lz\_lean\_ix\_id) | (Mandatory) Reference to record in LeanIX. | `string` | n/a | yes |
